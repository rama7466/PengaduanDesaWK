...
<body>
  <nav class="navbar shadow  navbar-expand-lg navbar-dark bg-success">
    <div class="container">
      <div class="navbar-brand"><strong>WIkrama Pengaduan masyarakat</strong></div>
    ...
    <div class="container ">
      <div class="row text-center py-4">
        <div class="col text-muted">
            &copy; {{date('Y')}} pengaduan wikrama by RAMA RAMDHANI
        </div>
      </div>
    </div>
  </footer>
